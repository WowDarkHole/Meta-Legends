const abi = [
	...
	},
	{
		inputs: [
			...
			{internalType: "uint256", name: "_timeRange", type: "uint256"},
		],
	...
	},
	{
		...
		outputs: [
			...
			{internalType: "uint256", name: "timeRange", type: "uint256"},
		],
		stateMutability: "view",
		type: "function",
	},
	...
	},
	{
		inputs: [
			...
			{internalType: "uint256", name: "_nb", type: "uint256"},
		],
		name: "givewayMint",
		outputs: [],
		stateMutability: "nonpayable",
	...
	{
		inputs: [{internalType: "uint256", name: "_nb", type: "uint256"}],
		name: "publicSaleMint",
		outputs: [],
	...
	{
		inputs: [{internalType: "address[]", name: "addresses", type: "address[]"}],
		name: "removeAddressesOfWhitelist",
		outputs: [],
		stateMutability: "nonpayable",
		type: "function",
	},
	...
	{
		inputs: [{internalType: "uint256", name: "_nb", type: "uint256"}],
		name: "setTotalPublicSaleClaimable",
		outputs: [],
		stateMutability: "nonpayable",
		type: "function",
	},
	{
		inputs: [{internalType: "uint256", name: "_nb", type: "uint256"}],
		name: "setTotalWhitelistClaimable",
		outputs: [],
		stateMutability: "nonpayable",
		type: "function",
	},
